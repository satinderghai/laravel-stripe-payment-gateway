          ...
          <table id="example1" class="table table-bordered table-striped" data-form="deleteForm">
           ...
           <tbody>
            ...
            <tr>
             ...
             <td class="align-center">{{ $value['tran_id'] }}</td>
            ...
            <td>
              <a href="{{action('App\Http\Controllers\backend\TransactionController@show', $value['id'])}}" class="btn btn-warning btn-xs show-btn">Show</a>
